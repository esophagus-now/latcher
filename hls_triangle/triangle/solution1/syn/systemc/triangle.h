...
struct triangle : public sc_module {
    // Port declarations 5
    sc_in_clk ap_clk;
    ...
    // Module declarations
    triangle(sc_module_name name);
    SC_HAS_PROCESS(triangle);
    ...
    static const sc_lv<32> ap_const_lv32_7D00;
    static const sc_lv<32> ap_const_lv32_BB80;
    static const sc_lv<32> ap_const_lv32_FFFF0600;
    static const sc_lv<24> ap_const_lv24_55556;
    static const sc_lv<24> ap_const_lv24_55555;
