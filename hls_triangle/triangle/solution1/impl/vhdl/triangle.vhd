...
begin
    ...
    ap_NS_fsm_assign_proc : process (out_V_1_ack_in, ap_CS_fsm, ap_CS_fsm_state1, ap_CS_fsm_state2)
    begin
        case ap_CS_fsm is
    ...
    out_V_1_vld_in_assign_proc : process(out_V_1_ack_in, ap_CS_fsm_state1)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state1) and (out_V_1_ack_in = ap_const_logic_1))) then 
    ...
    out_V_TDATA_blk_n_assign_proc : process(out_V_1_state, ap_CS_fsm_state1, ap_CS_fsm_state2)
    begin
    ...
    tmp_6_fu_66_p2 <= std_logic_vector(unsigned(err) + unsigned(ap_const_lv32_7D00));
