...
architecture behav of latcher is 
    attribute CORE_GENERATION_INFO : STRING;
    attribute CORE_GENERATION_INFO of behav : architecture is
    "latcher,hls_ip_2017_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7vx485tffg1157-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=1.971000,HLS_SYN_LAT=0,HLS_SYN_TPT=1,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=37,HLS_SYN_LUT=63}";
    ...
    signal Block_codeRepl1_proc_U0_in_V_V_TREADY : STD_LOGIC;
    signal Block_codeRepl1_proc_U0_out_V_V_TDATA : STD_LOGIC_VECTOR (31 downto 0);
    signal Block_codeRepl1_proc_U0_out_V_V_TVALID : STD_LOGIC;
